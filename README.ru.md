...
### [Скачать MeowShell для Windows x64 — установщик (рекомендуется)](https://github.com/kimi-1337/meowshell/releases/download/v2.3.0-beta.2/MeowShell-2.3.0-beta.2-win-x64-setup.exe)

| Версия | Скачать |
|---|---|
| Windows x64, установщик | [Скачать `.exe`](https://github.com/kimi-1337/meowshell/releases/download/v2.3.0-beta.2/MeowShell-2.3.0-beta.2-win-x64-setup.exe) |
| Windows x64, portable | [Скачать `.zip`](https://github.com/kimi-1337/meowshell/releases/download/v2.3.0-beta.2/MeowShell-2.3.0-beta.2-win-x64-portable.zip) |
| Windows ARM64, установщик | [Скачать `.exe`](https://github.com/kimi-1337/meowshell/releases/download/v2.3.0-beta.2/MeowShell-2.3.0-beta.2-win-arm64-setup.exe) |
| Windows ARM64, portable | [Скачать `.zip`](https://github.com/kimi-1337/meowshell/releases/download/v2.3.0-beta.2/MeowShell-2.3.0-beta.2-win-arm64-portable.zip) |
| Полный комплект релиза | [Скачать общий `.zip`](https://github.com/kimi-1337/meowshell/releases/download/v2.3.0-beta.2/MeowShell-2.3.0-beta.2-release-bundle.zip) |

[Все файлы релиза и контрольные суммы SHA-256](https://github.com/kimi-1337/meowshell/releases/tag/v2.3.0-beta.2)
